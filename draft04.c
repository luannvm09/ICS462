...
Vehicle northBoundQueue[100];
Vehicle southBoundQueue[100];
...
void *northBound(void *arg)
{
    ...
    printf("NorthBound ");
    arrive((Vehicle*) arg);
    northBoundQueue[northIndex] = (Vehicle*) arg;
